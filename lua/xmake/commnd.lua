...
function M.init()
	...
	cmd("XmakeBuild", require("xmake.commnd").build, { nargs = 0 })
	cmd("XmakeBuildAll", require("xmake.commnd").build_all, { nargs = 0 })
	cmd("XmakeBuildTarget", require("xmake.commnd").build_target, { nargs = 0 })
	cmd("XmakeClean", require("xmake.commnd").clean, { nargs = 0 })
	cmd("XmakeCleanAll", require("xmake.commnd").clean_all, { nargs = 0 })
	cmd("XmakeCleanTarget", require("xmake.commnd").clean_target, { nargs = 0 })
end
